...
public class NotifyService extends Service {
   ...
   // private static final int NOTIFICATION = 123;
    ...
    public static final String INTENT_NOTIFY = "com.examle.chkee.ScrapBook.Service";
        ...
        //   Intent intent = new Intent(this, SharingActivity.class);
         ...
         //  PendingIntent contentIntent = PendingIntent.getActivity(this, (int) System.currentTimeMillis(), intent, 0);
           ...
           builder.setContentIntent(contentIntent)
                   ...
                   .setContentText(text).setSmallIcon(R.drawable.ic_dialog_alert);
